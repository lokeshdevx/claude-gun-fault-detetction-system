...
const STATUS_ICONS = {
  ...
  processing: <div className="w-3 h-3 border border-blue-500 border-t-transparent rounded-full animate-spin" />,
...
export function ImageGrid() {
  ...
  return (
    <div className="flex flex-col h-full gap-3">
      ...
      {images.length > 0 && (
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-white border border-gray-300 rounded-lg pl-8 pr-3 py-2 text-xs text-gray-800 placeholder-gray-400 focus:outline-none focus:border-gray-500 focus:ring-2 focus:ring-gray-200"
          />
        </div>
      )}
      ...
      {/* Empty state */}
      {images.length === 0 && (
        <div className="flex-1 flex flex-col items-center justify-center gap-3 text-gray-400 border-2 border-dashed border-gray-300 rounded-xl">
          <AlertCircle className="w-10 h-10" />
          <div className="text-center">
            <p className="text-sm font-medium text-gray-600">No images yet</p>
            <p className="text-xs text-gray-400">Capture or upload barrel images</p>
          </div>
        </div>
      )}
        ...
        <AnimatePresence>
          {filtered.map((img, i) => (
            <motion.div
              ...
              className="group bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-gray-400 hover:shadow-md transition-all cursor-pointer"
              ...
              <div className="flex gap-3 p-2.5">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-1">
                    <div>
                      <p className="text-xs font-semibold text-gray-900 truncate max-w-[130px]">
                ...
                <div className="h-0.5 bg-gray-100">
                  <div
                    ...
                    style={{
                      ...
                      background: img.qualityScore >= 70 ? "#059669" : img.qualityScore >= 50 ? "#d97706" : "#dc2626",
                    }}
                  />
                </div>
              )}
